...
Generated by `floorplan.py`. 188 parts, 138 nets.
...
Placed courtyard area **2890 mm²**, of which the twelve relays are **52%**. At a packing factor of 2.5 that is a minimum of **7225 mm²** — about 85 mm square — before any of the deferred blocks.
...
|---|---|---|---|
| beside the mixer in its 1590J | 3639 mm² | 7225 mm² | **3586 mm² short** |
| as a mezzanine on the mixer's own outline | 6189 mm² | 7225 mm² | **1036 mm² short** |
