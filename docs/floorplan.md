...
Generated by `floorplan.py`. 158 parts, 102 nets.
...
Placed courtyard area **1324 mm²**. At a packing factor of 2.5 that is a minimum of **3310 mm²** — about 58 mm square — before any of the deferred blocks.

**It was 7225 mm² one pass ago.** The coarse pad occupied 1566 mm² of placed courtyard — 1512 of relay envelope and 54 of resistors that are not coming back — which was **54%** of the board, the relays alone being 52%. `design.pad_benefit()` is why it went, and the argument there is noise rather than area; this is what the noise argument was worth in millimetres.
...
|---|---|---|---|
| beside the mixer in its 1590J | 3639 mm² | 3310 mm² | **329 mm² spare** |
| as a mezzanine on the mixer's own outline | 6189 mm² | 3310 mm² | **2879 mm² spare** |
