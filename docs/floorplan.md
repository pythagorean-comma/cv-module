...
Generated by `floorplan.py`. 238 parts, 149 nets.
...
Placed courtyard area **2700 mm²**. At a packing factor of 2.5 that is a minimum of **6750 mm²** — about 82 mm square — before any of the deferred blocks.

**With the coarse pad still fitted this board would be 10665 mm².** It occupied 1566 mm² of placed courtyard — 1512 of relay envelope and 54 of resistors that are not coming back — which was **37%** of the board, the relays alone being 35%. `design.pad_benefit()` is why it went, and the argument there is noise rather than area; this is what the noise argument was worth in millimetres.
